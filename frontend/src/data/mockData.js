...
export const defaultSlides = templates[0].slidesData;
...
export const sharedMaterials = [
  {
    ...
    level: 'N5',
    owner: 'ミンアン先生',
    filename: 'n5_vocab_image_set.pdf',
    url: '/materials/n5_vocab_image_set.pdf',
  ...
  },
  {
    ...
    level: 'N4',
    owner: 'Tuệ先生',
    filename: 'daily_conversation_role_cards.pdf',
    url: '/materials/daily_conversation_role_cards.pdf',
    mime: 'application/pdf',
  },
  {
    id: 'mat_003',
    ...
    level: '初級',
    owner: '山田先生',
    filename: 'kanji_stroke_order_worksheet.pdf',
    url: '/materials/kanji_stroke_order_worksheet.pdf',
    mime: 'application/pdf',
  },
  {
    id: 'mat_004',
    ...
    level: 'N3',
    owner: '佐々木先生',
    filename: 'n3_grammar_sentence_list.pdf',
    url: '/materials/n3_grammar_sentence_list.pdf',
    mime: 'application/pdf',
  },
];

export function cloneSlides(slides) {
  return slides.map((slide, index) => ({ ...slide, id: `s${index + 1}_${Date.now()}_${index}` }));
}
