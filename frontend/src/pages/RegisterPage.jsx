...
export function RegisterPage({ nav, profile }) {
  ...
  function submit(e){
    ...
    const exists = users.some(user => String(user.email).toLowerCase() === email.toLowerCase());
    if(!exists) localStorage.setItem('smartslide_users', JSON.stringify([...users, { name, email, password }]));
  ...
  return <div className="auth-page">
    <section className="hero rich-hero">
      ...
      <div className="hero-content">
        ...
        <h2><Bi jp="ベトナムの日本語教師を支援" vi="Hỗ trợ giáo viên tiếng Nhật tại Việt Nam" profile={profile}/></h2>
    ...
    <form className="auth-card" onSubmit={submit}>
      ...
      <button className="pink full auth-submit"><Bi jp="アカウント作成" vi="Tạo tài khoản" profile={profile}/></button>
