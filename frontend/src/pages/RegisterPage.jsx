...
export function RegisterPage({ nav }) {
  ...
  function submit(e){
    ...
    if(!exists) localStorage.setItem('smartslide_users', JSON.stringify([...users, { name, email }]));
  ...
  return <div className="auth-page">
    ...
    <form className="auth-card" onSubmit={submit}>
      ...
      <button className="pink full auth-submit">登録する</button><button type="button" className="link" onClick={() => nav('login')}>ログイン画面へ</button>
    </form>
  </div>
}
