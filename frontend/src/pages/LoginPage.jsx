...
export function LoginPage({ nav, profile }) {
  ...
  return <div className="auth-page">
    ...
    <form className="auth-card" onSubmit={submit}>
      ...
      <input name="email" type="email" placeholder="teacher@example.com" defaultValue="teacher@example.com" />
      <label><Bi jp="パスワード" vi="Mật khẩu" profile={profile}/></label>
      <input name="password" type="password" placeholder="••••••••" defaultValue="12345678" />
      ...
      <button className="pink full auth-submit"><Bi jp="ログイン" vi="Đăng nhập" profile={profile}/></button>
