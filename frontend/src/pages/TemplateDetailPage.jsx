    ...
    <section className="detail-card">
      ...
      <div className="detail-info">
        ...
        <div className="template-detail-actions">
          <button className="outline" onClick={() => nav('editor', { templateId: t.id, deckId: null })}><Bi jp="使用する" vi="Sử dụng" profile={profile}/></button>
          <button className="pink" onClick={() => nav('editor',{templateId:t.id, deckId:null})}><Bi jp="このテンプレートで作成" vi="Tạo bằng mẫu này" profile={profile}/></button>
        </div>
      </div>
    </section>
  </AppLayout>
